...
This project defines the complete architectural specifications for a high-availability Task Management System designed for distributed software development teams.
...
**Project Goal:** To architect a robust Digital Task Management System (TMS) specifically engineered for software development workflows. The system aims to restore team alignment, clarify task hierarchies, and streamline global collaboration through system design.

## Project Scope

### 1. Requirements Engineering & Interaction Modeling
- Requirements Specification: Defines functional and non-functional requirements.
...
- System Modeling: Defines the structural organization of the system through UML Class Diagrams, identifying attributes and methods for each object.
- Modular Subsystem Design: Decomposes the system into the following subsystems using UML Component Diagrams:
    ...
    - Notification
    - Data Management.
- Subsystem Package Design: Organizes subsystems into logical packages to ensure a maintainable code base.
- Hardware/Software Mapping: Bridges software and infrastructure (physical nodes) using a UML Deployment Diagram.

### 3. Security, Identity & Observability
- Identity Layer: Architects a secure authentication framework using OpenID Connect and OAuth 2.0, Modeling the interaction between Users and the Authorization Server.
- Global Software Control: Integrated a log-management strategy using Better Stack.
